...
export function isJXASafeString(input: string): boolean {
	...
	const dangerousPatterns = [
		...
		// Note: Removed unmatched quote patterns - they were too restrictive and
		// blocked valid inputs like "it's a file". The escapeStringForJXA function
		// properly handles quote escaping, so preemptive rejection isn't needed.
	];
